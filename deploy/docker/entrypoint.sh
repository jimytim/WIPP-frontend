...
sed -i \
  ...
  -e 's|DISPLAY_CLOUD_IMPORT_OPTION|'"${DISPLAY_CLOUD_IMPORT_OPTION}"'|' \
  -e 's|GOOGLE_WIPP_CLIENT_ID|'"${GOOGLE_WIPP_CLIENT_ID}"'|' \
  -e 's|GOOGLE_WIPP_CLIENT_REDIRECT_URI|'"${GOOGLE_WIPP_CLIENT_REDIRECT_URI}"'|' \
